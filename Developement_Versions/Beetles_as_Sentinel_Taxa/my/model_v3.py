...
class EventMILModelV3(nn.Module):
    def __init__(
        self,
        num_species: int,
        num_domains: int,
    ...
    def forward(
        ...
        # RMSE-optimized v3: focus on mean accuracy while preserving sigma output.
...
class Model:
    def __init__(self, checkpoint_path: Optional[str] = None):
        ...
        self.image_size = 224
        self.calib_size = 128
        self.checkpoint_path = checkpoint_path or os.path.join(os.path.dirname(__file__), "model_v3.pth")
    ...
    def load(self):
        ...
        self.model = EventMILModelV3(num_species=num_species, num_domains=num_domains)
