...
class EventMILModelV6(nn.Module):
    def __init__(
        self,
        num_species: int,
        num_domains: int,
        ...
        attn_in_dim = 1024 + embedding_dim
...
class Model:
    def __init__(self, checkpoint_path: Optional[str] = None):
        ...
        self.image_size = 224
        self.calib_size = 128
        self.checkpoint_path = checkpoint_path or os.path.join(os.path.dirname(__file__), "model_v6.pth")
    ...
    def load(self):
        ...
        self.model = EventMILModelV6(num_species=num_species, num_domains=num_domains)
