...
here = Path.cwd()
candidate_paths = [
    here / "NEUSTG_19502020_12stations.mat",
    here / "Predicting Coastal Flooding Events" / "NEUSTG_19502020_12stations.mat"
]
...
for candidate in candidate_paths:
    ...
    raise FileNotFoundError("Could not locate NEUSTG_19502020_12stations.mat")
...
# ============================================
SELECTED_STATIONS =  ['Annapolis', 'Atlantic_City', 'Charleston', 'Washington', 'Wilmington', 'Eastport', 'Portland', 'Sewells_Point', 'Sandy_Hook']
...
selected_sea_level = sea_level[:, selected_idx]  # time x selected_stations
...
# hist_start = pd.to_datetime(np.random.choice(date_range))
...
print(f"X_test shape: {X_test.shape}  (stations x {7*len(FEATURES)} features)")
...
# {
#   "auc": 0.5565690089899873,
#   "acc": 0.8846653545839283,
#   "f1": 0.9387777398429498,
#   "mcc": 0.004451552983516831,
#   "n": 77739
# }