...
# ========= 🎛️ 控制台 =========
VALIDATION_MODE = False  # True=看驗證分數, False=生成上傳模型
# ==============================
...
FEATURES = [
    ...
    'dist_mean_7d',                # 新增: 過去7天平均距離
    'month_sin', 'month_cos',      # 補回: 季節性
    'year_norm'                    # 補回: 年份趨勢
]
...
if VALIDATION_MODE:
    ...
    with open("xgb_models_improved_add_feat.pkl", "wb") as f:
        pickle.dump(models, f)
    # print("\n✅ 模型已儲存為 xgb_models_improved.pkl")
    print("\n✅ 模型已儲存為 xgb_models_improved_add_feat.pkl")

# 🏆 最佳門檻 (Best Threshold): 0.3400

# 📊 驗證成績 (加入歷史淹水特徵):
# Confusion Matrix: [TP=198582, FP=70446, TN=25140, FN=8106]
# AUC:       0.7703
# Accuracy:  0.7401
# F1 Score:  0.8349
    
# {
# "auc": 0.6536731147489164,
# "acc": 0.8759953176655219,
# "f1": 0.9335300769506578,
# "mcc": 0.06171656025745392,
# "n": 77739
# }
...
# 📊 驗證成績 (V4 全特徵):
# Confusion Matrix: [TP=197531, FP=67266, TN=28320, FN=9157]
# AUC:       0.8020
# Accuracy:  0.7472
# F1 Score:  0.8379
    
# {
#   "auc": 0.6990817354802503,
#   "acc": 0.8025830020967597,
#   "f1": 0.8851401414511844,
#   "mcc": 0.19314617259108433,
#   "n": 77739
# }